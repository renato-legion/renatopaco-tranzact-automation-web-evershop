...
#Author: Renato Paco
  ...
  Scenario Outline: [HAPPY PATH] Flujo E2E Prueba Tranzact
    ...
    Examples:
      ...
      | Adriana Ordoñez | aaaa     | adriadurdiSDp@rSddXffffffX.com | Kids     | First     | 2         | XL    | White  | Women    | Second    | 5         | S     | Red    | Men      | Third     | 3         | XL    | Black  |
      | Renato Ordoñez | aaaa     | aPakiftSDodl@rSddXffffffX.com | Kids     | Fourth     | 4         | S    | Black  | Women    | Third    | 11         | L     | White    | Men      | First     | 9         | XL    | Black  |
      | Kira Ordoñez | aaaa     | KiradrjlfeSDi@rSddXffffssX.com | Kids     | Third     | 42         | X    | White  | Women    | First    | 7         | XL     | Black    | Men      | Second     | 459         | XL    | Black  |
      | Camote Ordoñez | aaaa     | CamotefDFifo@holihoggli.com | Kids     | Second     | 51         | L    | Black  | Women    | Fourth    | 23         | X     | Blue    | Men      | First     | 9         | XL    | Black  |
      | Diana Ordoñez | aaaa     | DianakdfjFDS@fholiholijhheje.com | Kids     | First     | 13         | XL    | White  | Women    | First    | 79         | M     | White    | Men      | Fourth     | 1349         | L    | Red  |
